...
**CAD Files:** Include pngs and CAD files of the Shazamboni itself.

**Images File:** Include PDFs and images of the Shazamboni and Shaz App that we need to report.
